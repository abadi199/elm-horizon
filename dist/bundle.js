...
var _user$project$Horizon$insertPort = _elm_lang$core$Native_Platform.outgoingPort(
	'insertPort',
	function (v) {
		return [
			v._0,
...
var _user$project$Horizon$insertCmd = _elm_lang$core$Basics$curry(_user$project$Horizon$insertPort);
var _user$project$Horizon$insertSubscription = _elm_lang$core$Native_Platform.incomingPort(
	'insertSubscription',
	A2(
...
var _user$project$Horizon$insertSub = function (tagger) {
	return _user$project$Horizon$insertSubscription(
...
var _user$project$Horizon$storeCmd = _elm_lang$core$Basics$curry(_user$project$Horizon$storePort);
var _user$project$Horizon$storeSubscription = _elm_lang$core$Native_Platform.incomingPort(
	'storeSubscription',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
...
var _user$project$Horizon$storeSub = function (tagger) {
	return _user$project$Horizon$storeSubscription(
		_user$project$Horizon$responseTagger(tagger));
};
var _user$project$Horizon$upsertPort = _elm_lang$core$Native_Platform.outgoingPort(
	'upsertPort',
	function (v) {
		return [
			v._0,
...
var _user$project$Horizon$upsertCmd = _elm_lang$core$Basics$curry(_user$project$Horizon$upsertPort);
var _user$project$Horizon$upsertSubscription = _elm_lang$core$Native_Platform.incomingPort(
	'upsertSubscription',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
...
var _user$project$Horizon$upsertSub = function (tagger) {
...
var _user$project$Horizon$removeAllCmd = _elm_lang$core$Basics$curry(_user$project$Horizon$removeAllPort);
...
var _user$project$Horizon$removePort = _elm_lang$core$Native_Platform.outgoingPort(
	'removePort',
	function (v) {
		return [v._0, v._1];
	});
var _user$project$Horizon$removeCmd = _elm_lang$core$Basics$curry(_user$project$Horizon$removePort);
var _user$project$Horizon$removeSubscription = _elm_lang$core$Native_Platform.incomingPort(
	'removeSubscription',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
...
var _user$project$Horizon$removeSub = function (tagger) {
...
var _user$project$Horizon$updateCmd = _elm_lang$core$Basics$curry(_user$project$Horizon$updatePort);
...
var _user$project$Horizon$updateSub = function (tagger) {
	return _user$project$Horizon$updateSubscription(
		_user$project$Horizon$responseTagger(tagger));
};
var _user$project$Horizon$replacePort = _elm_lang$core$Native_Platform.outgoingPort(
	'replacePort',
	function (v) {
		return [
			v._0,
...
var _user$project$Horizon$replaceCmd = _elm_lang$core$Basics$curry(_user$project$Horizon$replacePort);
var _user$project$Horizon$replaceSubscription = _elm_lang$core$Native_Platform.incomingPort(
	'replaceSubscription',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
...
var _user$project$Horizon$replaceSub = function (tagger) {
...
var _user$project$Chat$updateMessage = F3(
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					messages: A2(
						_elm_lang$core$List$map,
						function (message) {
							return _elm_lang$core$Native_Utils.eq(message.id, id) ? _p1._0 : message;
						},
						model.messages)
				});
		}
	});
var _user$project$Chat$updateMessageMode = function (mode) {
	var updateDraft = function (message) {
		var _p2 = mode;
		if (_p2.ctor === 'ViewMode') {
			return _elm_lang$core$Native_Utils.update(
				message,
				{draft: ''});
		} else {
	...
	return _user$project$Chat$updateMessage(
		function (message) {
			return updateDraft(
				_elm_lang$core$Native_Utils.update(
					message,
...
var _user$project$Chat$updateMessageDraft = function (draft) {
	return _user$project$Chat$updateMessage(
		function (message) {
			return _elm_lang$core$Native_Utils.update(
				message,
...
var _user$project$Chat$findMessage = F2(
	function (id, model) {
...
var _user$project$Chat$toList = A2(
	...
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(message.id)
			},
				{
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(message.name)
			},
				{
				ctor: '_Tuple2',
				_0: 'value',
				_1: _elm_lang$core$Json_Encode$string(message.value)
			}
			]));
};
var _user$project$Chat$newMessageEncoder = function (message) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$Chat$Message = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, value: c, draft: d, mode: e};
	});
...
var _user$project$Chat$emptyMessage = {id: '', name: '', value: '', draft: '', mode: _user$project$Chat$ViewMode};
var _user$project$Chat$init = {
	...
	_0: {
		...
		name: '',
		input: _user$project$Chat$emptyMessage,
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'Send':
				return {
					...
					_1: A2(
						...
						_user$project$Chat$toList(
							_user$project$Chat$newMessageEncoder(model.input)))
				};
			case 'SendResponse':
				var _p4 = _p3._0;
				if (_p4.ctor === 'Err') {
			...
			case 'Edit':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Chat$updateMessageMode, _user$project$Chat$EditMode, _p3._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateDraft':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Chat$updateMessageDraft, _p3._1, _p3._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'CancelEdit':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Chat$updateMessageMode, _user$project$Chat$ViewMode, _p3._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Update':
				var _p9 = _p3._0;
				var updater = function (message) {
					return _elm_lang$core$Native_Utils.update(
						message,
						{value: message.draft, draft: '', mode: _user$project$Chat$ViewMode});
				};
				var maybeMessage = A2(
					_elm_lang$core$Maybe$map,
					updater,
					A2(_user$project$Chat$findMessage, _p9, model));
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Chat$updateMessageMode, _user$project$Chat$ViewMode, _p9, model),
					_1: A2(
						_elm_lang$core$Maybe$withDefault,
						...
						A2(
							...
							function (_p8) {
								return A2(
									_user$project$Horizon$updateCmd,
									_user$project$Chat$collectionName,
									_user$project$Chat$toList(
										_user$project$Chat$messageEncoder(_p8)));
							},
							maybeMessage))
				};
			default:
...
var _user$project$Chat$UpdateResponse = function (a) {
	return {ctor: 'UpdateResponse', _0: a};
};
var _user$project$Chat$Update = function (a) {
	return {ctor: 'Update', _0: a};
};
var _user$project$Chat$CancelEdit = function (a) {
	return {ctor: 'CancelEdit', _0: a};
};
var _user$project$Chat$UpdateDraft = F2(
	function (a, b) {
		return {ctor: 'UpdateDraft', _0: a, _1: b};
	});
...
var _user$project$Chat$DeleteMessage = function (a) {
	return {ctor: 'DeleteMessage', _0: a};
};
var _user$project$Chat$viewMessage = F2(
	function (model, msg) {
		var _p11 = msg.mode;
		if (_p11.ctor === 'ViewMode') {
			return A2(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$value(msg.draft),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_user$project$Chat$UpdateDraft(msg.id))
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onClick(
										_user$project$Chat$CancelEdit(msg.id))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onClick(
										_user$project$Chat$Update(msg.id))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
...
var _user$project$Chat$SendResponse = function (a) {
	return {ctor: 'SendResponse', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Horizon$insertSub(_user$project$Chat$SendResponse),
				_user$project$Horizon$removeAllSub(_user$project$Chat$DeleteAllResponse),
				_user$project$Horizon$updateSub(_user$project$Chat$UpdateResponse)
			]));
};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Chat$viewMessage(model),
						model.messages)),
					A2(
					_elm_lang$html$Html$p,
					_elm_lang$core$Native_List.fromArray(
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html$text(item.value)
							]));
				},
				_p0._0));
	}
...
var _user$project$Search$messageDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'value',
	_elm_lang$core$Json_Decode$string,
	A3(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html_Events$onInput(_user$project$Search$Input),
								_elm_lang$html$Html_Attributes$value(model.keyword)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Platform_Sub$map,
				_user$project$Main$SearchMsg,
				_user$project$Search$subscriptions(model.search))
			]));
};
...
var _user$project$SillyChat$encodeChatMessage = function (message) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'from',
				_1: _elm_lang$core$Json_Encode$string(message.from)
			},
				{
				ctor: '_Tuple2',
				_0: 'msg',
				_1: _elm_lang$core$Json_Encode$string(message.msg)
			}
			]));
};
var _user$project$SillyChat$encode = function (from) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'from',
				_1: _elm_lang$core$Json_Encode$string(from.from)
			}
			]));
};
var _user$project$SillyChat$init = {
	ctor: '_Tuple2',
	_0: {
		messages: _elm_lang$core$Native_List.fromArray(
			[])
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$SillyChat$encode(
								{from: 'elmo'})
							])),
						_user$project$Horizon$Limit(5)
					])),
				A2(
				_user$project$Horizon$insertCmd,
				'chat_messages',
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$SillyChat$encodeChatMessage(
						{from: 'elmo', msg: 'Hello World!'})
					])),
				A2(
				_user$project$Horizon$insertCmd,
				'chat_messages',
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$SillyChat$encodeChatMessage(
						{from: 'elmo', msg: 'From Elm Conference'})
					])),
				A2(
				_user$project$Horizon$insertCmd,
				'chat_messages',
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$SillyChat$encodeChatMessage(
						{from: 'abadi', msg: 'Just ignore me!'})
					]))
			]))
};
var _user$project$SillyChat$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NewChatMessage') {
			var _p3 = _p0._0;
			var _p1 = A2(_elm_lang$core$Debug$log, 'NewChatMessage', _p3);
			var _p2 = _p3;
			if (_p2.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
			...
			var _p4 = A2(_elm_lang$core$Debug$log, 'InsertResponse', _p0._0);
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$SillyChat$view = function (model) {
	return _elm_lang$html$Html$text(
		_elm_lang$core$Basics$toString(model));
};
var _user$project$SillyChat$Model = function (a) {
	return {messages: a};
};
var _user$project$SillyChat$ChatMessage = F2(
	function (a, b) {
		return {from: a, msg: b};
	});
var _user$project$SillyChat$chatMessageDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'msg',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'from',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$SillyChat$ChatMessage)));
var _user$project$SillyChat$InsertResponse = function (a) {
	return {ctor: 'InsertResponse', _0: a};
};
var _user$project$SillyChat$NewChatMessage = function (a) {
	return {ctor: 'NewChatMessage', _0: a};
};
var _user$project$SillyChat$subscriptions = function (_p5) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_user$project$Horizon$watchSub, _user$project$SillyChat$chatMessageDecoder, _user$project$SillyChat$NewChatMessage),
				_user$project$Horizon$insertSub(_user$project$SillyChat$InsertResponse)
			]));
};
var _user$project$SillyChat$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$SillyChat$init, view: _user$project$SillyChat$view, update: _user$project$SillyChat$update, subscriptions: _user$project$SillyChat$subscriptions})
};
...
Elm['SillyChat'] = Elm['SillyChat'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['SillyChat'], 'SillyChat', typeof _user$project$SillyChat$main === 'undefined' ? null : _user$project$SillyChat$main);
